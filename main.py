...
# 1回の学習で何枚の画像を使うか
flags.DEFINE_integer('batch_size', 10, '##IMPORTANT!!  Batch size Must divide evenly into the dataset sizes.')
...
def loss(logits, labels):
  # 交差エントロピーの計算
  cross_entropy = -tf.reduce_sum(labels*tf.log(logits + 1e-10))
